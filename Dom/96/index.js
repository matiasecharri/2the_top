...
//This is used to remove the filtered array if the user uses the X button generated by the navigator on the ss
const input = (input, array, container) => {
...
const app = async () => {
  try {
    ...
    input($searchBar, data, $cointainer);
  } catch (error) {
